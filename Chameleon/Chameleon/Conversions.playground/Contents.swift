...
XCPCaptureValue("lilyWhite", lilyWhite)
XCPCaptureValue("lilyWhiteFlat", lilyWhite.flatColor)
...
XCPCaptureValue("lilyWhiteDark", lilyWhiteDark)
XCPCaptureValue("lilyWhiteDarkFlat", lilyWhiteDark.flatColor)
let charcoal = UIColor(red: 0.26, green: 0.26, blue: 0.26, alpha: 1)
XCPCaptureValue("charcoal", charcoal)
XCPCaptureValue("charcoalFlat", charcoal.flatColor)
...
XCPCaptureValue("charcoalDark", charcoalDark)
XCPCaptureValue("charcoalDarkFlat", charcoalDark.flatColor)
let gray = UIColor(red: 0.56, green: 0.56, blue: 0.56, alpha: 1)
XCPCaptureValue("gray", gray)
XCPCaptureValue("grayFlat", gray.flatColor)
...
XCPCaptureValue("grayDark", grayDark)
XCPCaptureValue("grayDarkFlat", grayDark.flatColor)
let loblolly = UIColor(red: 0.73, green: 0.73, blue: 0.73, alpha: 1)
XCPCaptureValue("loblolly", loblolly)
XCPCaptureValue("loblollyFlat", loblolly.flatColor)
...
XCPCaptureValue("loblollyDark", loblollyDark)
XCPCaptureValue("loblollyDarkFlat", loblollyDark.flatColor)
let apple = UIColor(red: 0.33, green: 0.6, blue: 0.23, alpha: 1)
XCPCaptureValue("apple", apple)
XCPCaptureValue("appleFlat", apple.flatColor)
...
XCPCaptureValue("appleDark", appleDark)
XCPCaptureValue("appleDarkFlat", appleDark.flatColor)
let copper = UIColor(red: 0.73, green: 0.47, blue: 0.22, alpha: 1)
XCPCaptureValue("copper", copper)
XCPCaptureValue("copperFlat", copper.flatColor)
...
XCPCaptureValue("copperDark", copperDark)
XCPCaptureValue("copperDarkFlat", copperDark.flatColor)
let danube = UIColor(red: 0.37, green: 0.6, blue: 0.83, alpha: 1)
XCPCaptureValue("danube", danube)
XCPCaptureValue("danubeFlat", danube.flatColor)
...
XCPCaptureValue("danubeDark", danubeDark)
XCPCaptureValue("danubeDarkFlat", danubeDark.flatColor)
let paleCerulean = UIColor(red: 0.64, green: 0.76, blue: 0.9, alpha: 1)
XCPCaptureValue("paleCerulean", paleCerulean)
XCPCaptureValue("paleCeruleanFlat", paleCerulean.flatColor)
...
XCPCaptureValue("paleCeruleanDark", paleCeruleanDark)
XCPCaptureValue("paleCeruleanDarkFlat", paleCeruleanDark.flatColor)
let crayonPurple = UIColor(red: 0.55, green: 0.35, blue: 0.67, alpha: 1)
XCPCaptureValue("crayonPurple", crayonPurple)
XCPCaptureValue("crayonPurpleFlat", crayonPurple.flatColor)
...
XCPCaptureValue("crayonPurpleDark", crayonPurpleDark)
XCPCaptureValue("crayonPurpleDarkFlat", crayonPurpleDark.flatColor)
let deepChestnut = UIColor(red: 0.72, green: 0.3, blue: 0.26, alpha: 1)
XCPCaptureValue("deepChestnut", deepChestnut)
XCPCaptureValue("deepChestnutFlat", deepChestnut.flatColor)
...
XCPCaptureValue("deepChestnutDark", deepChestnutDark)
XCPCaptureValue("deepChestnutDarkFlat", deepChestnutDark.flatColor)
let mauve = UIColor(red: 0.88, green: 0.65, blue: 0.99, alpha: 1)
XCPCaptureValue("mauve", mauve)
XCPCaptureValue("mauveFlat", mauve.flatColor)
...
XCPCaptureValue("mauveDark", mauveDark)
XCPCaptureValue("mauveDarkFlat", mauveDark.flatColor)
let athensGray = UIColor(red: 0.88, green: 0.87, blue: 0.88, alpha: 1)
XCPCaptureValue("athensGray", athensGray)
XCPCaptureValue("athensGrayFlat", athensGray.flatColor)
...
XCPCaptureValue("athensGrayDark", athensGrayDark)
XCPCaptureValue("athensGrayDarkFlat", athensGrayDark.flatColor)
let mountainMist = UIColor(red: 0.57, green: 0.57, blue: 0.57, alpha: 1)
XCPCaptureValue("mountainMist", mountainMist)
XCPCaptureValue("mountainMistFlat", mountainMist.flatColor)
...
XCPCaptureValue("mountainMistDark", mountainMistDark)
XCPCaptureValue("mountainMistDarkFlat", mountainMistDark.flatColor)
let hippieGreen = UIColor(red: 0.39, green: 0.59, blue: 0.35, alpha: 1)
XCPCaptureValue("hippieGreen", hippieGreen)
XCPCaptureValue("hippieGreenFlat", hippieGreen.flatColor)
...
XCPCaptureValue("hippieGreenDark", hippieGreenDark)
XCPCaptureValue("hippieGreenDarkFlat", hippieGreenDark.flatColor)
let axolotl = UIColor(red: 0.33, green: 0.42, blue: 0.29, alpha: 1)
XCPCaptureValue("axolotl", axolotl)
XCPCaptureValue("axolotlFlat", axolotl.flatColor)
...
XCPCaptureValue("axolotlDark", axolotlDark)
XCPCaptureValue("axolotlDarkFlat", axolotlDark.flatColor)
let celery = UIColor(red: 0.65, green: 0.76, blue: 0.38, alpha: 1)
XCPCaptureValue("celery", celery)
XCPCaptureValue("celeryFlat", celery.flatColor)
...
XCPCaptureValue("celeryDark", celeryDark)
XCPCaptureValue("celeryDarkFlat", celeryDark.flatColor)
let moonstoneBlue = UIColor(red: 0.49, green: 0.66, blue: 0.78, alpha: 1)
XCPCaptureValue("moonstoneBlue", moonstoneBlue)
XCPCaptureValue("moonstoneBlueFlat", moonstoneBlue.flatColor)
...
XCPCaptureValue("moonstoneBlueDark", moonstoneBlueDark)
XCPCaptureValue("moonstoneBlueDarkFlat", moonstoneBlueDark.flatColor)
let flamenco = UIColor(red: 0.89, green: 0.53, blue: 0.26, alpha: 1)
XCPCaptureValue("flamenco", flamenco)
XCPCaptureValue("flamencoFlat", flamenco.flatColor)
...
XCPCaptureValue("flamencoDark", flamencoDark)
XCPCaptureValue("flamencoDarkFlat", flamencoDark.flatColor)
let limerick = UIColor(red: 0.56, green: 0.73, blue: 0.13, alpha: 1)
XCPCaptureValue("limerick", limerick)
XCPCaptureValue("limerickFlat", limerick.flatColor)
...
XCPCaptureValue("limerickDark", limerickDark)
XCPCaptureValue("limerickDarkFlat", limerickDark.flatColor)
let mayaBlue = UIColor(red: 0.42, green: 0.69, blue: 0.96, alpha: 1)
XCPCaptureValue("mayaBlue", mayaBlue)
XCPCaptureValue("mayaBlueFlat", mayaBlue.flatColor)
...
XCPCaptureValue("mayaBlueDark", mayaBlueDark)
XCPCaptureValue("mayaBlueDarkFlat", mayaBlueDark.flatColor)
let eastSide1 = UIColor(red: 0.64, green: 0.54, blue: 0.7, alpha: 1)
XCPCaptureValue("eastSide1", eastSide1)
XCPCaptureValue("eastSide1Flat", eastSide1.flatColor)
...
XCPCaptureValue("eastSide1Dark", eastSide1Dark)
XCPCaptureValue("eastSide1DarkFlat", eastSide1Dark.flatColor)
let seaNymph = UIColor(red: 0.53, green: 0.71, blue: 0.64, alpha: 1)
XCPCaptureValue("seaNymph", seaNymph)
XCPCaptureValue("seaNymphFlat", seaNymph.flatColor)
...
XCPCaptureValue("seaNymphDark", seaNymphDark)
XCPCaptureValue("seaNymphDarkFlat", seaNymphDark.flatColor)
let eastSide2 = UIColor(red: 0.71, green: 0.56, blue: 0.79, alpha: 1)
XCPCaptureValue("eastSide2", eastSide2)
XCPCaptureValue("eastSide2Flat", eastSide2.flatColor)
...
XCPCaptureValue("eastSide2Dark", eastSide2Dark)
XCPCaptureValue("eastSide2DarkFlat", eastSide2Dark.flatColor)
let reefGold = UIColor(red: 0.64, green: 0.53, blue: 0.23, alpha: 1)
XCPCaptureValue("reefGold", reefGold)
XCPCaptureValue("reefGoldFlat", reefGold.flatColor)
...
XCPCaptureValue("reefGoldDark", reefGoldDark)
XCPCaptureValue("reefGoldDarkFlat", reefGoldDark.flatColor)
let indianYellow = UIColor(red: 0.88, green: 0.65, blue: 0.35, alpha: 1)
XCPCaptureValue("indianYellow", indianYellow)
XCPCaptureValue("indianYellowFlat", indianYellow.flatColor)
...
XCPCaptureValue("indianYellowDark", indianYellowDark)
XCPCaptureValue("indianYellowDarkFlat", indianYellowDark.flatColor)
let moonRaker = UIColor(red: 0.82, green: 0.83, blue: 0.96, alpha: 1)
XCPCaptureValue("moonRaker", moonRaker)
XCPCaptureValue("moonRakerFlat", moonRaker.flatColor)
...
XCPCaptureValue("moonRakerDark", moonRakerDark)
XCPCaptureValue("moonRakerDarkFlat", moonRakerDark.flatColor)
let montana = UIColor(red: 0.22, green: 0.22, blue: 0.22, alpha: 1)
XCPCaptureValue("montana", montana)
XCPCaptureValue("montanaFlat", montana.flatColor)
...
XCPCaptureValue("montanaDark", montanaDark)
XCPCaptureValue("montanaDarkFlat", montanaDark.flatColor)
let solitude = UIColor(red: 0.91, green: 0.95, blue: 1, alpha: 1)
XCPCaptureValue("solitude", solitude)
XCPCaptureValue("solitudeFlat", solitude.flatColor)
...
XCPCaptureValue("solitudeDark", solitudeDark)
XCPCaptureValue("solitudeDarkFlat", solitudeDark.flatColor)
let silverChalice = UIColor(red: 0.66, green: 0.71, blue: 0.65, alpha: 1)
XCPCaptureValue("silverChalice", silverChalice)
XCPCaptureValue("silverChaliceFlat", silverChalice.flatColor)
...
XCPCaptureValue("silverChaliceDark", silverChaliceDark)
XCPCaptureValue("silverChaliceDarkFlat", silverChaliceDark.flatColor)
